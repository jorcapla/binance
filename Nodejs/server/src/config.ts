...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8888';
    'jhipster.clientApp.name' = 'cryptoservices';
    ...
    'jhipster.mail.from' = 'cryptoservices@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'cryptoservices API';
    'jhipster.swagger.description' = 'cryptoservices API documentation';
    ...
    'eureka.instance.appname' = 'cryptoservices';
    'eureka.instance.instanceId' = 'cryptoservices:${random.value}';
    ...
    'cloud.config.name' = 'cryptoservices';
